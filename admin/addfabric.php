...
<div class="row">
    ...
    <div class="col-md-4 col-lg-2 col-xl-2 col-sm-4 col-xs-4 navigation-links-container">
        ...
        <a class="links" id="indicator" href="adminhome.php"><ion-icon name="arrow-back-outline"></ion-icon></a>
            <a class="links" href="addfabric.php"><ion-icon name="refresh-outline"></ion-icon></a>
        </div>
        ...
        <div class="links-box">
            ...
            <a class="btn links active" href="addfabric.php">FEED FABRIC</a>
    ...
    <form class="form text-center" action="<?php echo $_SERVER["PHP_SELF"]?>" method="post" enctype="multipart/form-data">
        <h2 class="content-name">Load Your New Fabric</h2>
        <input type="text" placeholder="Enter Fabric Name" required name="name">
...
{
    $sql="INSERT INTO cloth_fabric (CFABRIC_TITTLE) VALUES ('{$_POST["name"]}')";
    $db->query($sql);
    echo"<script>alert('Your New Fabric is successfully feeded...')</script>";
}
}
