...
<div class="row">
    ...
    <div class="col-md-4 col-lg-2 col-xl-2 col-sm-4 col-xs-4 navigation-links-container">
        ...
        <a class="links" id="indicator" href="adminhome.php"><ion-icon name="arrow-back-outline"></ion-icon></a>
            <a class="links" href="addsize.php"><ion-icon name="refresh-outline"></ion-icon></a>
        </div>
        ...
        <div class="links-box">
            ...
            <a class="btn links active" href="addsize.php">FEED SIZE</a>
    ...
    <div class="col-md-8 col-lg-10 col-xl-10 col-sm-8 col-xs-8 content-display-container">
        <form class="form" action="<?php echo $_SERVER["PHP_SELF"]?>" method="post" enctype="multipart/form-data">
            <h2 class="content-name text-center">Load Your New Size</h2>
                <input type="text" placeholder="Enter Size Name" required name="name">
...
{
    $sql="INSERT INTO cloth_size (CSIZE_TITTLE) VALUES ('{$_POST["name"]}')";
    $db->query($sql);
    echo"<script>alert('Your New Size is successfully feeded...')</script>";
}
}
